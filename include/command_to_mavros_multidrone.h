  ...
  command_to_mavros_multidrone(const std::string& ID) : command_nh("~") {
    ...
    */
    ...
    position_target_sub = command_nh.subscribe<mavros_msgs::PositionTarget>(
        mavros_setpoint_raw_target_local, 10, &command_to_mavros_multidrone::pos_target_cb, this);
    ...
    attitude_target_sub = command_nh.subscribe<mavros_msgs::AttitudeTarget>(
        mavros_setpoint_raw_target_attitude, 10, &command_to_mavros_multidrone::att_target_cb, this);
    ...
    actuator_target_sub = command_nh.subscribe<mavros_msgs::ActuatorControl>(
        mavros_target_actuator_control, 10, &command_to_mavros_multidrone::actuator_target_cb, this);
