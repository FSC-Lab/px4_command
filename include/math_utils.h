 ...
 *
 *               1、转换 ref to
 *https://github.com/PX4/Matrix/blob/56b069956da141da244926ed7000e89b2ba6c731/matrix/Euler.hpp
 ***************************************************************************************************************************/
#ifndef MATH_UTILS_H
#define MATH_UTILS_H
...
enum vector_component { Vector_X = 0, Vector_Y = 1, Vector_Z = 2 };
enum quaternion_component { Quat_w = 0, Quat_x = 1, Quat_y = 2, Quat_z = 3 };
